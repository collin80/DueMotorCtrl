...
void serialPrintMenu() {
    ...
    Logger::console("HALLAB=%i - Set Hall AB digital input ", settings.hallAB);
    Logger::console("HALLBC=%i - Set Hall BC digital input ", settings.hallBC);
    Logger::console("HALLCA=%i - Set Hall CA digital input ", settings.hallCA);
